---
description: "End-to-end SDLC orchestrator. Use when building a feature or app from scratch: gather requirements, plan, code, review, test, and fix bugs. Routes work to PM, Architect, Developer, Reviewer, and QA subagents."
...
```
GATHERING_REQS → PLANNING → CODING → REVIEW → TESTING → (loop back on failure) → DONE
```
